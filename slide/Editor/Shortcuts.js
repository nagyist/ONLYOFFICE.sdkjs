...
(function(undefined) {
	...
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.Save] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.Save, [new AscShortcut(keyCodes.KeyS, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.Print] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.Print, [new AscShortcut(keyCodes.KeyP, true, false, false, false)], true);
	...
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.ShowContextMenu] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.ShowContextMenu, [new AscShortcut(keyCodes.F10, false, true, false, false)], true);
	...
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.Duplicate] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.Duplicate, [new AscShortcut(keyCodes.KeyD, true, false, false, false)], true);
	...
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.Group] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.Group, [new AscShortcut(keyCodes.KeyG, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.UnGroup] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.UnGroup, [new AscShortcut(keyCodes.KeyG, true, true, false, false)], true);
	...
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.EditUndo] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.EditUndo, [new AscShortcut(keyCodes.KeyZ, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.EditRedo] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.EditRedo, [new AscShortcut(keyCodes.KeyY, true, false, false, false)], true);
	...
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.CopyFormat] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.CopyFormat, [new AscShortcut(keyCodes.KeyC, true, false, true, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.PasteFormat] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.PasteFormat, [new AscShortcut(keyCodes.KeyV, true, false, true, false)], true);
	...
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.AddHyperlink] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.AddHyperlink, [new AscShortcut(keyCodes.KeyK, true, false, false, false)], true);
	...
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.EditSelectAll] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.EditSelectAll, [new AscShortcut(keyCodes.KeyA, true, false, false, false)], true);
	...
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.ShowParaMarks] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.ShowParaMarks, [new AscShortcut(keyCodes.Digit8, true, true, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.Bold] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.Bold, [new AscShortcut(keyCodes.KeyB, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.Italic] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.Italic, [new AscShortcut(keyCodes.KeyI, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.Underline] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.Underline, [new AscShortcut(keyCodes.KeyU, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.Strikethrough] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.Strikethrough, [new AscShortcut(keyCodes.Digit5, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.Subscript] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.Subscript, [new AscShortcut(keyCodes.Period, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.Superscript] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.Superscript, [new AscShortcut(keyCodes.Comma, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.BulletList] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.BulletList, [new AscShortcut(keyCodes.KeyL, true, true, false, false)], true);
	...
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.IncreaseFont] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.IncreaseFont, [new AscShortcut(keyCodes.BracketRight, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.DecreaseFont] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.DecreaseFont, [new AscShortcut(keyCodes.BracketLeft, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.CenterAlign] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.CenterAlign, [new AscShortcut(keyCodes.KeyE, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.JustifyAlign] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.JustifyAlign, [new AscShortcut(keyCodes.KeyJ, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.RightAlign] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.RightAlign, [new AscShortcut(keyCodes.KeyR, true, false, false, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.LeftAlign] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.LeftAlign, [new AscShortcut(keyCodes.KeyL, true, false, false, false)], true);
	...
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.EuroSign] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.EuroSign, [new AscShortcut(keyCodes.KeyE, true, false, true, false)], true);
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.EmDash] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.EmDash, [], true); //todo
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.EnDash] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.EnDash, [], true);//todo
	...
	c_oAscDefaultShortcuts[Asc.c_oAscPresentationShortcutType.SpeechWorker] = new AscShortcutAction(Asc.c_oAscPresentationShortcutType.SpeechWorker, [new AscShortcut(keyCodes.KeyZ, true, false, true, false)], true);
	...
	function getStringFromShortcutType(type) {
		switch (type) {
			...
			case Asc.c_oAscPresentationShortcutType.EuroSign:
				return "EuroSign";
			case Asc.c_oAscPresentationShortcutType.EmDash:
				return "EmDash";
	...
	function getShortcutTypeFromString(str) {
		switch (str) {
			...
			case "EmDash":
				return Asc.c_oAscPresentationShortcutType.EmDash;
			case "EnDash":
