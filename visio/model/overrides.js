...
AscFormat.GenerateDefaultTheme = function GenerateDefaultTheme(presentation, opt_fontName) {
	let phClr = 14;
	return AscFormat.ExecuteNoHistory(function () {
		...
		theme.setFontScheme(new AscFormat.FontScheme());
		theme.themeElements.fontScheme.setMajorFont(new AscFormat.FontCollection(theme.themeElements.fontScheme));
		theme.themeElements.fontScheme.setMinorFont(new AscFormat.FontCollection(theme.themeElements.fontScheme));
		...
		scheme.colors[11] = AscFormat.CreateUniColorRGB(0x00, 0x00, 0xFF);
